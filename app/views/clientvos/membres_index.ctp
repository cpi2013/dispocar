<div class="clients index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('numeroclient');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $clientvo['Clientvo']['numeroclient']; ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $clientvo['Clientvo']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $clientvo['Clientvo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $clientvo['Clientvo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
