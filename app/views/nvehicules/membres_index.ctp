<div class="nvehicules index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('éditer', true), array('action' => 'edit', $nvehicule['Nvehicule']['id'])); ?>
			<?php echo $this->Html->link(__('supprimer', true), array('action' => 'delete', $nvehicule['Nvehicule']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $nvehicule['Nvehicule']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
